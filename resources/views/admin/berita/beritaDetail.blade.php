                    ...
                    <div class="d-flex flex-md-row flex-sm-column w-auto justify-content-start align-items-center">
                        ...
                        <div class="align-self-start">
                            ...
                            <button type="button" id="btn-hapus" class="btn align-items-center"
                                onclick="openDeleteModal({{ $berita->id }}, '{{ $berita->judul_berita }}')">
                            ...
                            <div class="carousel-inner">
                                ...
                                @if (empty($gambarArray))
                                    <div class="carousel-item active">
                                        <img style="width: 100%" src="{{ asset('assets/images/image.png') }}"
                                            class="d-block w-100">
                                    </div>
                                @endif
                            </div>
