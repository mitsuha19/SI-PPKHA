    ...
    <div class="main-content d-flex flex-column align-items-center">
        ...
        <div class="d-flex flex-row justify-content-center gap-2 w-100 mb-3">
            <form class="w-50 d-flex" action="{{ route('admin.berita.berita') }}" method="GET">
                <input type="text" id="berita" name="search" class="form-control" placeholder="Cari Berita..."
                    ...
                    <div class="background-card">
                        <div class="card-information d-flex align-items-center px-3">
                            ...
                            @if (!empty($gambarArray) && isset($gambarArray[0]))
                                <img style="width: 100px" src="{{ asset($gambarArray[0]) }}" alt="Gambar Berita">
                            @else
                            ...
                            <div class="ps-3 w-100">
                                    ...
                                    <div class="align-self-start">
                                        <div class="ms-auto d-flex gap-2">
                                            <button type="button" id="btn-edit"
                                                ...
                                                onclick="window.location.href='{{ route('admin.berita.beritaEdit', $item->id) }}'">
                                ...
                                <div class="detail">
                                    <a
                                        href="{{ route('admin.berita.beritaDetail', ['id' => $item->id]) }}">Selengkapnya..</a>
                                </div>
                            </div>
                        </div>
                    </div>
