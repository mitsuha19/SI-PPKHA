    ...
    <div class="main-content d-flex flex-column align-items-center">
        ...
        <div class="d-flex flex-row justify-content-center gap-2 w-100 mb-3">
            <form class="w-50 d-flex" action="{{ route('admin.artikel.artikel') }}" method="GET">
                <input type="text" id="artikel" name="search" class="form-control" placeholder="Cari Artikel..."
                                ...
                                <div class="align-self-start">
                                    <div class="ms-auto d-flex gap-2">
                                        <button type="button" id="btn-edit"
                                            ...
                                            onclick="window.location.href='{{ route('admin.artikel.artikelEdit', $item->id) }}'">
                                            <i class='bx bx-pencil fs-5 me-2'></i> Edit
                                        </button>

                                        <button type="button" id="btn-hapus"
                                            class="btn btn-primary px-4 py-2 fw-bold d-flex align-items-center"
                                            onclick="openDeleteModal({{ $item->id }}, '{{ $item->judul_artikel }}')">
