...
<div class="main-content">
  ...
  <div class="box-form">
      <form action="">
        ...
        <input type="text" class="form-control mb-3" id="judul" placeholder="Masukkan judul Pengumuman">
        <label for="deskripsi" class="form-label poppins-bold text-black mb-2">Deskripsi Pengumuman:</label>
        <textarea class="form-control mb-3" id="deskripsi" placeholder="Masukkan deskripsi Pengumuman"></textarea>  
